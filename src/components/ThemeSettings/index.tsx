...
const ThemeSettings: FC = () => {
  ...
  const buttonClass =
    "ease duration-200 w-full bg-white border-2 border-gray-100 text-black font-bold py-2 px-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white first:rounded-l-xl last:rounded-r-xl  [&:not(:last-child)]:border-r-0";
  const selectedClasses =
    "z-10 peer !border-r-2 [&+*]:border-l-0 !bg-blue-100 dark:!bg-blue-900 selected !border-blue-700 dark:!border-blue-500";
