      ...
      color === ButtonColorEnum.secondary
        ...
        : color === ButtonColorEnum.error
          ...
          : color === ButtonColorEnum.primaryLight
            ? "text-blue-700 bg-blue-100 [&:not(:disabled)]:hover:bg-blue-200 dark:text-white dark:bg-blue-950 [&:not(:disabled)]:dark:hover:bg-blue-700 dark:focus:ring-blue-400"
