  ...
  return createPortal(
    ...
    >
      <div
        ...
        onClick={handleClose}
      ></div>
      <div className="overflow-hidden z-10 ease duration-200 dark:bg-zinc-900 dark:text-white flex flex-col bg-white max-h-full w-full max-w-[768px] rounded-xl shadow-lg relative">
        <button
